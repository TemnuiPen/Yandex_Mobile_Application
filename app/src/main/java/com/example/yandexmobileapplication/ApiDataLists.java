...
/*
    public LinkedList<ApiDataLists> defaultList = new LinkedList<>(Arrays.asList(
            (new ApiDataLists("SanyaHuiSosi", "SHS", ApplicationStatus.IS_NOT_IN_FAVOURITE)),
...
/*
    public LinkedList<ApiDataLists> SetDefaultValues() {
        return {
